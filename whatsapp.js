...
async function fetchSheetData() {
    try {
        const response = await fetch('https://script.google.com/macros/s/AKfycbw5LOjfJ98OAYW4SrlESjhko3MAwGu6WvemWN28bVmqIfGLOj0ekIvfVxQjcnOAWJub/exec');
...
function sendLink() {
    ...
    const fixedNumber = document.getElementById('fixed-whatsapp-link').dataset.fixedNumber || "+201103082250"; // Default to Yasser's number
...
function updateFixedNumber() {
    ...
    if (selectedNumber) {
        ...
        document.getElementById('fixed-whatsapp-link').dataset.fixedNumber = "+201103082250"; // Default number
    }
}

// Open the Google Sheet
function openGoogleSheet() {
    window.open('https://docs.google.com/spreadsheets/d/1IPwVtaeLYBnF96oxKSfO9NdP51OzlyQeDfAVGzd2ERY/edit?gid=0#gid=0', '_blank');
}
